...
\author{Precoma Andrea, Schievano Matteo}
\date{Distributed Systems 1 Project -- July 15, 2026}

\begin{document}
    \maketitle
    \input{chapters/01_Read_Write_Mgmt}
    \input{chapters/02_Coordinator_Election}
    \input{chapters/03_Crash_Mgmt}
    \input{chapters/04_LLM}
